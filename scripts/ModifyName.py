CANONICAL_RES_NAME = {'  A', '  G', '  U', '  C', 'A', 'G', 'U', 'C',
                      'VAL', 'ALA', 'ARG', 'ASP', 'ASN', 'LEU', 'ILE', 'PHE', 'PRO', 'TRP',
                      'SER', 'TYR', 'CYS', 'MET', 'GLN', 'THR', 'GLU', 'LYS', 'HIS', 'GLY',
                      'ASH', 'CYM', 'CYX', 'GLH', 'LYN', 'HID', 'HIE', 'HIP'}
...
DICT_RES_NAME = {' RA': '  A', ' RG': '  G', ' RU': '  U', ' RC': '  C',
                 ...
                 'RA': '  A', 'RG': '  G', 'RU': '  U', 'RC': '  C',
                 'YG': '  G','I': '  G','T': '  U','IU': '  U','IG': '  G',
                 'CH': '  C','IC': '  C','0C': '  C','0U': '  U','0G': '  G',
                 'DG': '  G','N': '  C','rA': '  A','rG': '  G','rU': '  U',
                 'rC': '  C',
                 'DT': '  U', ' DT':'  U',
                 'DC': '  C', ' DC':'  C',
                 'DA': '  A', ' DA':'  A',
...
def modify_residue_atom_name(residues):
    ...
    for residue in residues:
        ...
        for atom in residue:
            ...
            #     atom.id = atom.id.replace('CA', 'C1\'')
            #     atom.name = atom.name.replace('CA', 'C1\'')
